...
import { getWPWorkSheetData } from '../actions/worksheets';
import { generateWeddingPhotographyWorksheet } from '../services/worksheet'
...
class WPWorkSheet extends Component {
    ...
    getCustId = async()=>{
        ...
        this.props.getWPWorkSheet(cust_id);
    }
    componentWillReceiveProps(nextProps){
        if(!nextProps.wpsorksheetstate){
            this.setState({
                isloading:false,
    ...
    handleCtnPress=()=>{
        ...
        generateWeddingPhotographyWorksheet(body,(result)=>{
...
function mapDispatchToProps(dispatch){
	return{
		getWPWorkSheet : (cust_id)=>{
			dispatch(getWPWorkSheetData(cust_id));
    }
  }	
}
function mapStateToProps(state){
  return {
      ...
      wpsorksheetstate:state.wpworksheet.request
    }
}
