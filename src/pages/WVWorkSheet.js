...
import { getWVWorkSheetData } from '../actions/worksheets';
import { generateWeddingVideographyWorksheet } from '../services/worksheet'
...
class WVWorkSheet extends Component {
    ...
    handleCtnPress=()=>{
        ...
        generateWeddingVideographyWorksheet(body,(result)=>{
...
function mapDispatchToProps(dispatch){
	return{
		getWVWorkSheet : (cust_id)=>{
			dispatch(getWVWorkSheetData(cust_id));
    }
  }	
}
function mapStateToProps(state){
  return {
      ...
      wvworksheetstate:state.wvworksheet.request
    }
}
