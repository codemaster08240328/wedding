...
import { getEPWorkSheetData } from '../actions/worksheets';
import { generateEngagementPhotographyWorksheet } from '../services/worksheet'
...
class EPWorkSheet extends Component {
    ...
    handleCtnPress=()=>{
        ...
        generateEngagementPhotographyWorksheet(body,(result)=>{
...
function mapDispatchToProps(dispatch){
	return{
		getEPWorkSheet : (cust_id)=>{
			dispatch(getEPWorkSheetData(cust_id));
    }
  }	
}
function mapStateToProps(state){
  return {
      ...
      epworksheetstate:state.epworksheet.request
    }
}
